...
/*    public static void main(String[] args) {
   ...
   /* public void test_monitor_schedule_logic() {
    ...
    public String test_trade_precreate() {
        ...
        // 业务扩展参数，目前可添加由支付宝分配的系统商编号(通过setSysServiceProviderId方法)，详情请咨询支付宝技术支持
        ExtendParams extendParams = new ExtendParams();
        extendParams.setSysServiceProviderId("2088621955648073");
        ...
        switch (result.getTradeStatus()) {
            case SUCCESS:
                ...
                // 需要修改为运行机器上的路径
                filePath = String.format("D:\\临时文件夹\\蓝桥视频及Markdown笔记\\PracticeCode\\2021-4\\支付宝沙盒\\qr-%s.png",
